...
// STATUS: IN PROGRESS
// ==========================================================================
// Login chooser page. Lets the user pick a Customer or Administrator sign-in and go to the matching login page.
    ...
    <CustomerShell active="Home" accountActive={true}>
      ...
      <section className="select-page">
        ...
        <div className="select-grid">
          {/* Choose "Customer" -> go to customer login */}
          ...
          {/* Choose "Administrator" -> go to admin login */}
